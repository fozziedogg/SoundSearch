...
// MARK: - Enums
// Note: SwiftProtobuf enums must NOT have a Swift raw type — RawRepresentable
// is satisfied manually so that UNRECOGNIZED(Int) can carry its value.
...
struct Ptsl_RequestHeader: SwiftProtobuf.Message, Equatable {
...
struct Ptsl_Request: SwiftProtobuf.Message, Equatable {
...
struct Ptsl_ResponseHeader: SwiftProtobuf.Message, Equatable {
...
struct Ptsl_Response: SwiftProtobuf.Message, Equatable {
